...
// Expose the stores for E2E tests (perf tests inject tasks directly).
...
if (typeof window !== 'undefined') {
  ...
  // View store holds ephemeral UI state (view mode, resource-view scroll,
  // selection) that E2E tests need to assert on independently of the file.
  (window as unknown as { __ganttlyViewStore?: unknown }).__ganttlyViewStore = useViewStore;
}
