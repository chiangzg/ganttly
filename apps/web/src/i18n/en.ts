...
export const en = {
  ...
  baseline: {
    ...
    addedCount: 'Added {{count}} items',
    deletedCount: '{{count}} original tasks deleted',
    taskCount: '{{count}} tasks',
    columnName: 'Name',
    stopCompare: 'Stop comparing this baseline',
    startCompare: 'Compare this baseline',
    stopCompareShort: 'Stop comparing',
    compareShort: 'Compare',
    renameAria: 'Rename baseline {{name}}',
    renameShort: 'Rename',
    deltaDays: '{{n}} d',
    deltaWorkDays: '{{n}} wd',
  ...
  drawer: {
    title: 'Edit task',
    // Drawer's five flat sections (2026-09 interaction redesign).
    sectionBasic: 'Basics',
    ...
    searchResource: 'Type a name or pinyin initials…',
    noMatchingResource: 'No matching resources',
    noResourcesYet: 'No resources yet — add members in the resource list first',
    removeAssignment: 'Remove resource',
  ...
  project: {
    ...
    trashDesc:
      'Project "{{name}}" will be removed from the project list. You can restore it from the trash later.',
    switcher: {
